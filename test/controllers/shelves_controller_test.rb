...
class ShelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelf" do
    assert_difference('Shelf.count') do
      post shelves_url, params: { shelf: { cubboard_id: @shelf.cubboard_id, description: @shelf.description, name: @shelf.name } }
    end
  ...
  test "should update shelf" do
    patch shelf_url(@shelf), params: { shelf: { cubboard_id: @shelf.cubboard_id, description: @shelf.description, name: @shelf.name } }
